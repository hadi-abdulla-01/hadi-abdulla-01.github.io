  ...
  return (
    ...
    >
      ...
      <nav className="absolute top-0 left-0 right-0 z-50 p-6 md:p-8">
        <div className="flex items-center justify-between max-w-7xl mx-auto bg-black/20 backdrop-blur-sm rounded-lg px-6 py-3 shadow-lg border border-white/10">
          {/* Logo */}
          <motion.div
          ...
          <div className="hidden md:flex items-center space-x-8">
            <button
              ...
              className="text-white hover:text-gray-300 transition-all duration-300 hover:shadow-lg px-3 py-2 rounded-lg hover:bg-white/10"
            >
              About me
            </button>
            <button
            ...
            <button
              ...
              className="bg-white text-black px-6 py-2 rounded-full font-semibold hover:bg-gray-200 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105"
            >
              CONTACT ME
            </button>
          </div>
        ...
        {isMenuOpen && (
          <motion.div
            ...
            className="md:hidden mt-4 bg-black/90 backdrop-blur-sm rounded-lg p-4 shadow-xl border border-white/20"
          >
            <div className="flex flex-col space-y-4">
              <button
                onClick={() => scrollToSection("about")}
                className="text-white hover:text-gray-300 transition-all duration-300 text-left px-3 py-2 rounded-lg hover:bg-white/10 hover:shadow-md w-full"
              >
                About me
              </button>
              <button
              ...
              <button
                onClick={() => scrollToSection("contact")}
                className="bg-white text-black px-6 py-2 rounded-full font-semibold hover:bg-gray-200 transition-all duration-300 text-center shadow-lg hover:shadow-xl transform hover:scale-105"
              >
                CONTACT ME
              </button>
            </div>
          ...
          >
            ...
            >
              <motion.a
                ...
                whileTap={{ scale: 0.9 }}
                className="w-12 h-12 bg-gray-400 rounded-lg flex items-center justify-center text-black hover:bg-gray-500 transition-all duration-300 shadow-lg hover:shadow-xl"
              >
                <Mail size={20} />
              </motion.a>
              <motion.a
